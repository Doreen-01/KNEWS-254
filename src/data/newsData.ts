...
export const FEATURED_ARTICLES: Article[] = [
  {
    ...
    title: "Edwin Sifuna begins Western Kenya tour as political debate intensifies",
    slug: "edwin-sifuna-begins-western-kenya-tour-as-political-debate-intensifies",
    summary: "Nairobi Senator Edwin Sifuna addressed supporters in Kakamega during a grassroots mobilisation tour. Knews254 reporters are tracking the event, reactions, and verified statements from officials and participants.",
  ...
  },
  {
    ...
    title: "High Court Rules Kenya’s Next Presidential Election Date Fixed for August 11, 2026, Under Constitutional Mandate",
    slug: "high-court-rules-kenya-presidential-election-date-august-2026",
    summary: "A landmark High Court judgment sitting in Malindi has affirmed that Article 136 of the Constitution strictly dictates General Elections on the second Tuesday of August in the fifth year.",
    content: "Malindi, Kenya — In a groundbreaking legal precedent that reshapes Kenya's electoral calendar, the High Court sitting in Malindi has delivered a landmark ruling affirming that the next General Election for the President, Members of Parliament, and County Governors must legally be held on Tuesday, August 11, 2026.\n\nDelivering the judgment in a constitutional petition filed by legal oversight advocates, Presiding Judge M. Thande ruled that the Independent Electoral and Boundaries Commission (IEBC)'s internal strategic blueprint targeting August 2027 misinterpreted Article 136(2)(a) and Article 180 of the Constitution of Kenya 2010. The court emphasized that the five-year term of office for elected state officers is calculated precisely from the date of the previous election held on August 9, 2022.\n\nHowever, recognizing the immense logistical and administrative preparations required for a nationwide poll, Justice Thande exercised judicial discretion to suspend the immediate invalidation of current electoral preparations. The suspension allows the IEBC, National Treasury, and Parliament to align legal frameworks and budgetary allocations without triggering an unprecedented institutional crisis.\n\nReactions across the political divide were immediate. Legal scholars from the Law Society of Kenya (LSK) described the decision as a triumph for constitutionalism and judicial independence, while parliamentary leadership signaled intentions to file an urgent appeal at the Court of Appeal to seek clarification on executive term limits.",
    category: "politics",
    subcategory: "Constitutional Law & Courts",
    ...
    imageCaption: "High Court of Kenya gavel and constitutional law documents.",
    location: "High Court, Malindi",
    county: "Kilifi",
    isBreaking: true,
    isTrending: true,
    isFeatured: true,
    viewCount: 48900,
    tags: ["High Court", "Election 2026", "IEBC", "Constitutional Ruling", "Kelly Muthomi Kinoti"]
  },
  {
    id: "art-treasury-county-grants-2026",
    title: "National Treasury Releases Ksh 5.7 Billion Performance-Based Grants Across 46 Counties for Infrastructure",
    slug: "national-treasury-releases-5-7-billion-county-development-grants",
    summary: "46 Kenyan counties receive a major financial boost following Treasury's disbursement of Ksh 5.7 billion in performance-linked development grants for feeder roads and climate adaptation.",
    content: "Nairobi, Kenya — The National Treasury has officially released Ksh 5.7 billion in conditional, performance-based development grants to 46 county governments, providing a major boost to devolved infrastructure, urban market modernization, and climate resilience projects across the country.\n\nIn an official circular signed by Cabinet Secretary for National Treasury, the funds were allocated under the Kenya Devolution Support Program (KDSP) and Climate Smart Agricultural Urban Investment Framework. Counties that demonstrated superior financial governance, timely audit compliance, and efficient public participation scores—including Nakuru, Makueni, Kakamega, Meru, and Murang'a—received top-tier allocations exceeding Ksh 180 million each.\n\nCouncil of Governors (CoG) Finance Committee Chairperson welcomed the timely disbursement, noting that devolved units had faced severe liquidity constraints delaying essential feeder road maintenance and community water borehole projects during the recent heavy rainfall season.\n\nTreasury confirmed that a dedicated digital monitoring dashboard has been launched in partnership with the Ethics and Anti-Corruption Commission (EACC) to track contractor payments in real-time and prevent fund diversion.",
    category: "business",
    subcategory: "Devolution & Fiscal Policy",
    additionalCategories: ["latest", "economy"],
    author: {
      id: "auth-0",
      name: "Kelly Muthomi Kinoti",
      role: "Founder, Chairman & Super Administrator",
    ...
    imageCaption: "National Treasury headquarters in Nairobi CBD.",
    location: "Treasury Building, Nairobi",
    county: "Nairobi",
    isTrending: true,
    isFeatured: true,
    viewCount: 36200,
    tags: ["Devolution", "National Treasury", "County Grants", "Economy", "Kelly Muthomi Kinoti"]
  },
  {
    id: "art-thika-road-expressway-2026",
    title: "Government Unveils Ambitious Ksh 12 Billion Thika Road to Museum Hill Overhead Expressway Linkage",
    slug: "government-unveils-thika-road-museum-hill-expressway-linkage",
    summary: "The Ministry of Roads and Transport unveils an engineering masterplan for a dual-carriageway overhead bypass connecting Thika Superhighway directly to Museum Hill and the Nairobi Expressway.",
    content: "Nairobi, Kenya — Traffic gridlock along Nairobi’s northern transport corridor is set for dramatic relief following the government's official unveiling of a Ksh 12 billion overhead expressway linkage connecting Thika Superhighway to Museum Hill and the main Nairobi Expressway.\n\nUnveiled during an engineering briefing by the Kenya National Highways Authority (KeNHA) in Nairobi, the 4.8-kilometer elevated dual carriageway will feature modern multi-lane interchanges at Pangani, Forest Road, and Ojijo Road. The project aims to eliminate persistent bottleneck congestion at the Muthaiga and Globe Cinema roundabouts, saving commuters an estimated 45 minutes during peak morning and evening rush hours.\n\nFunding for the project will be executed via a Public-Private Partnership (PPP) model in conjunction with international infrastructure investors. Construction is slated to commence within 60 days following final environmental impact clearances by NEMA.\n\nTransport stakeholders and public service vehicle (PSV) operators have lauded the project, emphasizing that seamless connectivity between Thika, Westlands, and JKIA will significantly enhance business efficiency across the Nairobi Metropolitan Region.",
    category: "business",
    subcategory: "Infrastructure & Transport",
    additionalCategories: ["business", "latest"],
    author: {
      id: "auth-0",
      name: "Kelly Muthomi Kinoti",
      role: "Founder, Chairman & Super Administrator",
    ...
    imageCaption: "Expressway elevated interchange infrastructure in Nairobi.",
    location: "Pangani Interchange, Nairobi",
    county: "Nairobi",
    isTrending: true,
    isFeatured: true,
    viewCount: 41500,
    tags: ["Expressway", "Thika Road", "KeNHA", "Nairobi Infrastructure", "Kelly Muthomi Kinoti"]
  },
  {
    id: "art-kra-etims-revenue-surge-2026",
    title: "Kenya Revenue Authority Surges Past Ksh 240 Billion Quarterly Collection Following eTIMS AI Expansion",
    slug: "kra-surges-past-240-billion-quarterly-collection-etims-ai",
    summary: "KRA leadership confirms record revenue performance driven by automated real-time eTIMS invoice cross-verification and AI compliance tools targeting real estate and digital commerce.",
    content: "Nairobi, Kenya — The Kenya Revenue Authority (KRA) has achieved a milestone quarterly revenue collection exceeding Ksh 240 billion, marking an 18.4% year-on-year growth driven by advanced technology integration and automated tax compliance tools.\n\nKRA Board Chairperson Ndiritu Muriithi confirmed the impressive figures during a media briefing at Times Tower, attributing the success to the nationwide expansion of the Electronic Tax Invoice Management System (eTIMS) integrated with machine-learning algorithms that cross-verify VAT claims and supply chain transactions in real time.\n\nThe revenue collector highlighted significant revenue growth in the digital economy, commercial real estate leasing, and import customs valuation. KRA has also deployed automated compliance assistants that notify taxpayers of filing deadlines via SMS and WhatsApp, reducing penalties and improving voluntary compliance rates.\n\nBusiness leaders from the Kenya Association of Manufacturers (KAM) commended KRA’s shift toward technology-driven taxpayer engagement, while urging the authority to expedite VAT refund disbursements to maintain private sector liquidity.",
    category: "business",
    subcategory: "Taxation & Technology",
    additionalCategories: ["economy", "technology"],
    author: {
      id: "auth-0",
      name: "Kelly Muthomi Kinoti",
      role: "Founder, Chairman & Super Administrator",
    ...
    publishedAt: "2026-08-08T14:10:00Z",
    readTime: "4 min read",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=1200&auto=format&fit=crop&q=80",
    imageCaption: "Times Tower KRA headquarters in Nairobi CBD.",
    location: "Times Tower, Nairobi",
    county: "Nairobi",
    isTrending: true,
    isFeatured: true,
    viewCount: 39800,
    tags: ["KRA", "eTIMS", "Taxation", "Economy", "Kelly Muthomi Kinoti"]
  },
  {
